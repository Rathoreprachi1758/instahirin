...
CREATE TABLE IF NOT EXISTS `experties` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `expert_experty`;
CREATE TABLE IF NOT EXISTS `expert_experty` (
...
DROP TABLE IF EXISTS `expert_skill`;
...
INSERT INTO `hire` (`id`, `name`, `company`, `email`, `phone`, `message`, `created_at`, `updated_at`) VALUES
(1, 'Client', 'CC', 'cc@dummy.com', 'iknowit', 'Nothing can be done', '2023-07-26 04:39:29', '2023-07-26 04:39:29');
...
CREATE TABLE IF NOT EXISTS `hire_requests` (
  ...
  `message` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `hiring_type` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `virtual_assistance_call` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `availability_date` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `availability_time_from` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `availability_time_to` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
(2, 'Elis', 'elis@gmail.com', 0, '2023-07-26 04:35:39', '2023-07-26 04:35:39');
...
(1, 'Super User', 'admin@bizionic.com', '2023-05-27 00:32:37', '$2y$10$57iZywaVD9yYOjVC87.pXORRCE6XHo3WABP.YzhVj6VNLSpNtzqK6', 'wRY2lGxvbtk8UNV7n4NtEdU7qRHFrM4WTz3uR2SK6sBt9ZXhvzVoYBzz8MTw', '2023-05-27 00:32:37', '2023-05-27 00:32:37'),
(2, 'Admin', 'admin@gmail.com', NULL, '$2y$10$2XIALijsBCGcPS3GlSzUFOZUvAXj69Qg7U.KKEoNvSFXl.Yz/gByG', NULL, '2023-07-27 04:30:51', '2023-07-27 04:30:51');
