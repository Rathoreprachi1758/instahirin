...
class InstaHirinRequirement extends Resource
{
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            Select::make('Employment Role/Type','employment_type')->options(['Full Time'=>'Full Time, Permananet','Part Time'=>'Part Time', 'Remote'=>'Remote'])->displayUsingLabels()->filterable()->hideFromIndex(),
