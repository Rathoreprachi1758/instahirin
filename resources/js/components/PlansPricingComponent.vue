          ...
          <div class="coreServices_sectionDetail">
            ...
            <div class="coreTabs_data">
              <div v-if="selectedCategory">
                ...
                <div class="coreTabs_data_show" style="display: block">
                  <div class="pricingList">
                    <ul>
                      <li v-for="plan in selectedCategory.plans" :key="plan.id">
                        <div
                          class="pricingList_col"
                          :class="{ 'selected-plan': plan === selectedPlan }"
                          @click="selectPlan(plan)"
                        >
                          <strong class="categoryTittleTag">{{ plan.title_tag }}</strong>
...
export default {
  ...
  methods: {
    ...
    showCategory(category) {
      ...
      this.selectedPlan = category.plans.length > 0 ? category.plans[0] : null;
    },
