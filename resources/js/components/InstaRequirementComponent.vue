  ...
  > -->
    ...
    <div class="project_form">
        ...
        <div
            ...
            ref="successMessage"
        >
            Thank you for the submitting the inquiry. We will contact you
            shortly.
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="requireForm_lable">
                    <strong class="req_lable"
                        >Job / Project Descriptions:</strong
                    >
                    <div class="project_form_textarea">
                        ...
                        <div
                            id="character-count"
                            :class="{ 'limit-reached': isLimitReached1 }"
                        >
            ...
            <div class="col-lg-12 col-md-12">
                <div class="requireForm_lable">
                    <strong class="req_lable"
                        >Salary Range (Enter the Salary offered for this
                        Job/Project):</strong
                    >
                </div>
            </div>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="requireForm_lable">
                    <strong class="req_lable"
                        >Educational Qualification:</strong
                    >
                    <div class="project_form_select">
                        <select
                            class="form-select"
            ...
            <div class="col-lg-12 col-md-12">
                <div class="requireForm_lable">
                    ...
                    <div class="project_form_textarea">
                        ...
                        <div
                            id="character-count"
                            :class="{ 'limit-reached': isLimitReached2 }"
                        >
    ...
    methods: {
        ...
        updateCountProject() {
            if (this.project_description.length >= 5000) {
                this.project_description = this.project_description.substring(
                    0,
                    5000
                );
