<template>
  ...
  <div class="instaHirin_banner pb-5">
    <div class="auto_container">
      <div class="instaHirin_banner_inner">
        <span class="instaHirin_banner_avatar anim_bouncing"
          ><img src="/bizionic/images/insta_banner_avatar.png" alt="#"
        /></span>

        <div class="instaHirin_banner_info">
          <div class="custom_tittle text-left">
            <h2 class="p-0">
              <strong>Introducing</strong> “Hire Talent in <br />
              Minutes” <strong>and</strong> "Hire Beyond Borders"
            </h2>
            <h3 class="pt-1 pb-2">
              <strong>Revolutionize your</strong> Recruitment Process!
            </h3>
            <p class="p_color p-0">
              <b>Hire with Confidence.</b> Hire the right Talent instantly from an
              Unlimited, Prescreened, Assessed, Verified, Evaluated, and Qualified Pool of
              Professionals across the <b>GLOBE</b>.
            </p>
          </div>
            ...
            <div class="hireIn_minForm">
              <div class="hireIn_input project_form_field">
                ...
                <input
                  type="text"
                  name="query"
                  placeholder="Search Java, PHP, Laravel, Android, iOS...."
                  v-model="searchQuery"
                />
              </div>
              <div class="hireIn_btn">
                <input class="" type="submit" value="🔍 Hire In Minutes" />
        ...
        <div class="onboardSkilled_section">
          <div class="onboardSkill_options">
            <div class="custom_tittle">
              <h2>
                <strong>Onboard,</strong> Skilled Experts
                <strong>Providing</strong> Innovative Business Solutions
              </h2>
            </div>
          ...
          <div class="nativeSupport_list skilled_setting">
            <ul>
              ...
              <li>
                <a href="#">
                  <img
                    src="/bizionic/images/hirinSkill_icon14.png"
                    alt="#"
                    style="width: 84px; height: 84px; margin-bottom: 0px"
                  />
                </a>
              </li>
            </ul>
          ...
          <ul>
            <li v-for="category in categories" :key="category.id">
              <a
                ...
                :class="{
                  active:
                    this.selectedCategory && category.id === this.selectedCategory.id,
                }"
                >{{ category.title }}</a
              >
        ...
        <div class="otherSearch d-none">
          ...
          <div class="input-group">
            ...
            <div class="input-group-append">
              <button class="btn btn-secondary" type="button" @click="filterExperts">
  ...
  <div class="auto_container">
    <div class="showAll_btn mt-3">
      <a href="/hire/developer/developers-other/hirin-view-all" class="btn_default"
        >Show All</a
      >
    </div>
