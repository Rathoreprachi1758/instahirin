        ...
        <div class="row">
            <div class="col-lg-6 col-md-12">
                <div class="project_form_field">
                    <input type="text" value="" required placeholder="Name*" name="name" id="name"/>
            ...
            <div class="col-lg-6 col-md-12">
                <div class="project_form_field split_in_two"> 
                    ...
                    <select class="form-select codeCountry m-0 pr-0 pl-2" required id="country_code"   name="country_code">
                        <option value="">Country code</option>
                        <option v-for="item in countries" :value="item.phone" :key="item.phone">{{item.name}} +{{ item.phone }}</option>
                                              
                    </select>
                    </div>
                    <input class="filedPhone" type="text" value="" required placeholder="Phone / Skype / Whatsapp" name="phone" id="phone"/>
                </div>
            </div>
            <div class="col-lg-6 col-md-12">
                <div class="project_form_field">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="project_form_field">
                    <input type="text" value="" required placeholder="Enter business email*" name="email" id="email"/>
                </div>
            </div>
            <div class="col-lg-6 col-md-12">
                <div class="project_form_field">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="project_form_textarea">
                    <textarea placeholder="What can we build together....." name="message" id="message"></textarea>
                </div>
            </div>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="project_form_select">
                    <select class="form-select" required aria-label="Default select example" name="hiring_type" id="hiring_type">
            ...
            <div class="col-lg-12 col-md-12" v-for="(calender, index) in calenders" :key="index">
                <div class="dateTime_range">
                    ...
                    <div class="project_form_field ml-3">
                        <input type="time" value="" placeholder="Time" id="timePicker" name="from_time[]"/>
                    </div>
                    <label class="text-center">To</label>
                    <div class="project_form_field">
                    ...
                    <div class="addDeleteBtn" v-if="index > 0">
                         <a href="javascript:void(0)" @click="remove(index)" class="text-danger"><i class="fa fa-times-circle" aria-hidden="false"></i></a>
                    </div>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="addCallender">
                    <a href="javascript:void(0)" @click="addMore()" class="btn_default">Add Calender</a>
                </div>
            </div>
            ...
            <div class="col-lg-12 col-md-12" v-for="(calender1, index1) in calenders1" :key1="index1">
                <div class="dateTime_range">
                    ...
                    <div class="addDeleteBtn" v-if="index1 > 0">
                         <a href="javascript:void(0)" @click="remove1(index1)" class="text-danger"><i class="fa fa-times-circle" aria-hidden="true"></i></a>
                    </div>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="addCallender">
                    <a href="javascript:void(0)" @click="addMore1()" class="btn_default">Add Calender</a>
                </div>
            </div>
