<div class="insta_hirin_page ">
    ...
    <div class="postRequirment_section bg_fff">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 pl-0">
                        <div class="postRequirment_avatar">
                            <span><img src="/bizionic/images/requirement_avatar.png" alt="#" /></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="instaHirin_listOuter">
        ...
        <div class="meetTeam_section_detail">
            ...
            <div class="auto_container">
                <div class="custom_tittle">
                    <h2 class="">“Hire Talent in Minutes” <strong>with Bizionic</strong> <span
                            class="color_165099">InstaHirin</span></h2>
                    ...
                    <p class="p_color d-none">Create a successful remote workforce with international competence without
                        the costs and challenges associated with creating a subsidiary. The entire talent pool is
                        vetted, prescreened, and authenticated, including the verification of academic credentials,
                        prior work experience, projects, and technical expertise, as well as for any criminal or other
                        background checks. A dedicated project management team is also assigned to each project to
                        ensure monitoring, timely completion, and immediate replacements if required. By providing the
                        parties with access to dependable, skilled, and experienced mediator project managers and the
                        ecosystem to ensure project completion and obligation fulfillment, Bizionic fills the global
                        talent pool and project management ecosystem gap.</p>
                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-10 m-auto col-md-12">
                                    <div class="talentCheckList">
                                        <h4 class="text-center"><b>Bizionic InstaHirin,</b> Talent Onboarding Checklist
                                        </h4>
                                            ...
                                            <li>
                                                <p>
                                                    <a href="#" class="chrckIcon"><img
                                                            src="/bizionic/images/checkList_icon.png"
                                                            alt="#" /></a>
                                                    Personal Information
                                                    <a href="#" class="verified_icon"><img
                                                            src="/bizionic/images/verified_icon.png"
                                                            alt="#" /></a>
                                                </p>
                                            </li>
                                            <li>
                ...
                <div class="globalTalent_list">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 pr-0">
                            <div class="talentCheckList frList_sec">
                                <h4><b>Find Global Talent in </b> Minutes,<br> <b>On board in</b> Hours! </h4>
                        ...
                        <div class="col-lg-6 col-md-6 pl-0">
                            <div class="instaHirin_section bg_fff">
                                <div class="talentCheckList frList_sec bg_fff p-0">
                                    <h4><b>How to</b> Hire Talent in Minutes<br> <b>with</b> Bizionic InstaHirin!</h4>
                                </div>

                                <div class="hirinTal_avatar">
                                    <span><img src="/bizionic/images/insta_hirin_avatar.png" alt="#" /></span>
                                </div>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="howWork_text">
                                                ...
                                                <div class="howWork_text_info">
                                                    <h4>Search for the <b>"Talent"</b> with the required Skills</h4>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="howWork_text">
                                                ...
                                                <div class="howWork_text_info">
                                                    <h4>Click to <b>Schedule an Interview</b></h4>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="howWork_text">
                                                ...
                                                <div class="howWork_text_info">
                                                    <h4>Interview <b>Assessments"</b></h4>
                                                </div>
                                            </div>
                                        </li>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-12 aos-init " data-aos="fade-right" data-aos-duration="1000"
                                ...
                                <div class="custom_tittle p-0">
                                    <h2 class="text-left"><strong>For Companies, Build a Diverse Team <br> by
                                            Onboarding
                                        </strong> Global Talent</h2>

                                    <p class="text-left p_color">Create a successful remote workforce with
                                        international
                                        competence without the costs and challenges associated with creating a
                                        subsidiary. With the help of BIZIONIC's local entities, you can easily handle
                                        employee onboarding, compliance payroll, statutory benefits, and more.</p>

                                    <p class="text-left p_color">The entire talent pool that Bizionic sources are
                                        vetted, prescreened, and authenticated, including the verification of academic
                                        credentials, prior work experience, projects, and technical expertise, as well
                                        as for any criminal or other background checks. A dedicated project management
                                        team is also assigned to each project to guarantee timely completion and
                                        immediate replacements if required. This provides the parties access to a
                                        dependable, skilled, and experienced mediator and ecosystem to ensure project
                                        completion and obligation fulfillment.</p>

                                    <h6 class="font-italic p_color text-left my-2">Bizionic fills the global remote
                                        working ecosystem gap.</h6>
                            ...
                            <div class="col-lg-6 col-md-12 pt-3 aos-init " data-aos="fade-left"
                                data-aos-duration="1000" data-aos-easing="ease">
                                <div class="industryNew_section1_avatar">
                                    <span><img src="/bizionic/images/marketing_talent_img2.png"
                                            alt="#" /></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 buildCol">
                                <div class="buildTeam_col">
                                    <span><img src="/bizionic/images/global_icon1.png" alt="#"></span>
                                    <strong>HIRE ANYONE, ANYWHERE,<br> IN MULTIPLE COUNTRIES</strong>
                                    <p>Our turnkey work solutions enable a smoothened onboarding experience in Multiple
                                        countries, and you can enjoy compliant onboarding for your remote workers from
                                        Asia to Europe.</p>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 buildCol">
                                <div class="buildTeam_col">
                                    <span><img src="/bizionic/images/global_icon2.png" alt="#"></span>
                                    <strong>PAY IN <br> LOCAL CURRENCY</strong>
                                    <p>Multiple currency contract payment solution to ease the cost and minimize
                                        currency-related exposure. Employ the workforce globally and pay in your local
                                        currency with specially designed contracts in multiple currencies.</p>
                                </div>
                            </div>

                            <div class="col-lg-4 col-md-6 buildCol">
                                <div class="buildTeam_col">
                                    <span><img src="/bizionic/images/global_icon3.png" alt="#"></span>
                                    <strong>SAME DAY <br> ONBOARDING</strong>
                                    <p>Setting up your global talent remotely is tricky. BIZIONIC helps you build a
                                        compliant onboarding process so you welcome your international talent into your
                                        team and can hit the ground running in no time.</p>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 buildCol">
                                <div class="buildTeam_col">
                                    <span><img src="/bizionic/images/global_icon4.png" alt="#"></span>
                                    <strong>HIRE WHOM YOU WANT, <br> WE'LL DO THE REST</strong>
                                    <p>Unsure of how to incorporate newly acquired international talent. Don't worry; we
                                        can customize a contract to each company's needs and circumstances using our
                                        various tailored workforce contracts solutions.</p>
                                </div>
                            </div>

                            <div class="col-lg-4 col-md-6 buildCol">
                                <div class="buildTeam_col">
                                    <span><img src="/bizionic/images/global_icon5.png" alt="#"></span>
                                    <strong>YOUR LIABILITY IS <br> OUR LIABILITY</strong>
                                    <p>We ensure that you rightly fit in country-specific compliance, from wage
                                        regulations to employment rules, to reduce risks and avoid employment
                                        compliance-related issues globally.</p>
                                </div>
                            </div>

                            <div class="col-lg-4 col-md-6 buildCol">
                                <div class="buildTeam_col">
                                    <span><img src="/bizionic/images/global_icon6.png" alt="#"></span>
                                    <strong>24 X 7 <br> EXPERT SUPPORT</strong>
                                    <p>You are covered with our expert support 24x7, whenever and wherever you need it.
                                    </p>
                                </div>
                            </div>
                ...
                <div class="hireForm_banner">
                    <div class="hireForm_banner_detail">
                        <div class="custom_tittle">
                            ...
                            <p class="text-white p-0">InstaHirin VS JobPortals, Freelancers Portals, Recruitment Firms
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" width="500" class="text-left">InstaHirin Advantages
                                        </th>
                                ...
                                <tbody>
                                    <tr>
                                        <td scope="row">
                                            <p>Recruitment Duration</p>
                                        </td>
                                        <td class="text-left">
                                            <p>Time to Recruit a Skilled Professional</p>
                                        </td>
                                    ...
                                    <tr>
                                        <td scope="row">
                                            <p>Hire Qualified Talents in Minutes</p>
                                        </td>
                                        <td class="text-left">
                                            <p>Screened, Evaluated, and Verified candidates are accessible on the
                                                platform.</p>
                                        </td>
                                        <td class="minHirin_bg">
                                    ...
                                    <tr>
                                        <td scope="row">
                                            <p>Hire Beyond Borders</p>
                                        </td>
                                        <td class="text-left">
                                            <p>You can recruit highly qualified talent from around the world</p>
                                        </td>
                                        <td class="minHirin_bg">
                                            <div class="checkTable">
                                                <b><i class="fa fa-check-circle" aria-hidden="true"></i></b>
                                    ...
                                    <tr>
                                        <td scope="row">
                                            <p>Exact Skill Match</p>
                                        </td>
                                        <td class="text-left">
                                            <p>Experienced Team Leads verify the slacks & technical skills of the
                                                candidates.</p>
                                        </td>
                                        <td class="minHirin_bg">
                                            <div class="checkTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left">
                                            <p>Clients typically save around 38% to 50% on their total costs, which
                                                includes fixed salaries, incentives, benefits, and other employer
                                                obligations.</p>
                                        </td>
                                        <td class="minHirin_bg">
                                            <div class="checkTable">
                                    ...
                                    <tr>
                                        <td scope="row">
                                            <p>Software Development Funding</p>
                                        </td>
                                        <td class="text-left">
                                            <p>Development funding options are available.</p>
                                        </td>
                                        <td class="minHirin_bg">
                                            <div class="checkTable">
                                                <b><i class="fa fa-check-circle" aria-hidden="true"></i></b>
                                    ...
                                    <tr>
                                        <td scope="row">
                                            <p>Comprehensive - 10 Step Onboarding Evaluation</p>
                                        </td>
                                        <td class="text-left">
                                            <p>Validate the Talent background check, qualifications, academic
                                                credentials, criminal, past experiences and slack expertise.</p>
                                        </td>
                                        <td class="minHirin_bg">
                                            <div class="checkTable">
                                                <b><i class="fa fa-check-circle" aria-hidden="true"></i></b>
                                    ...
                                    <tr>
                                        <td scope="row">
                                            <p>Fair Recruitment Process</p>
                                        </td>
                                        <td class="text-left">
                                            <p>The onboarding and hiring process is free from corruption, bribery,
                                                racial bias, or preferential treatment; selection is solely based on
                                                merit.</p>
                                        </td>
                                        <td class="minHirin_bg">
                                            <div class="checkTable">
                                    ...
                                    <tr>
                                        <td scope="row">
                                            <p>Direct Recruitment - No Intermediaries</p>
                                        </td>
                                        <td class="text-left">
                                            <p>Companies assess interviews, assessment and deal directly with the
                                                Talent.</p>
                                        </td>
                                        <td class="minHirin_bg">
                                            <div class="checkTable">
                                    ...
                                    <tr>
                                        <td scope="row">
                                            <p>Immediate Substitution</p>
                                        </td>
                                        <td class="text-left">
                                            <p>Offer immediate replacement options</p>
                                        </td>
                                        <td class="minHirin_bg">
                                            <div class="checkTable">
                                                <b><i class="fa fa-check-circle" aria-hidden="true"></i></b>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left">
                                            <p>Over 150 in-house talents with diverse skills are available.</p>
                                        </td>
                                        <td class="minHirin_bg">
                                            <div class="checkTable">
                                                <b><i class="fa fa-check-circle" aria-hidden="true"></i></b>
                                    ...
                                    <tr>
                                        <td scope="row">
                                            <p>Efficient Project Oversight</p>
                                        </td>
                                        <td class="text-left">
                                            <p>Dedicated project teams ensure on-time project deliveries and tech and
                                                multiple slack support.</p>
                                        </td>
                                        <td class="minHirin_bg">
                                            <div class="checkTable">
                                                <b><i class="fa fa-check-circle" aria-hidden="true"></i></b>
                                    ...
                                    <tr>
                                        <td scope="row">
                                            <p>Training and Career Development</p>
                                        </td>
                                        <td class="text-left">
                                            <p>Provide ongoing mentoring, development, and training.</p>
                                        </td>
                                        <td class="minHirin_bg">
                                            <div class="checkTable">
                                                <b><i class="fa fa-check-circle" aria-hidden="true"></i></b>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left">
                                            <p>Expert support is available 24/7</p>
                                        </td>
                                        <td class="minHirin_bg">
                                            <div class="checkTable">
                                                <b><i class="fa fa-check-circle" aria-hidden="true"></i></b>
                                    ...
                                    <tr>
                                        <td scope="row">
                                            <p>Adherence to Global Compliance Standards</p>
                                        </td>
                                        <td class="text-left">
                                            <p>Ensure compliance with global regulations.</p>
                                        </td>
                                        <td class="minHirin_bg">
                                            <div class="checkTable">
                                                <b><i class="fa fa-check-circle" aria-hidden="true"></i></b>
