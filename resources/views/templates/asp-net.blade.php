                ...
                <div class="industryNew_section_detail">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-6 aos-init " data-aos="fade-right" data-aos-duration="1000" data-aos-easing="ease">
                                <div class=" custom_tittle text-left">
                                    ...
                                    Css, And Javascript Through Asp.Net <strong>Web Frameworks.</strong>
                                        ...
                                        <p class="p_color text-justify">Bizionic Technologies offers comprehensive ASP.NET development services to empower your digital solutions.</p>
                                        <br>
                            ...
                            <div class="col-lg-6 col-md-6 aos-init " data-aos="fade-left" data-aos-duration="1000" data-aos-easing="ease">
                                <div class="industryNew_section1_avatar">
                                    <span><img src="/bizionic/images/t_aspNet_avatar.png" alt="#" /></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="industryNew_section2_info aos-init" data-aos="fade-up" data-aos-duration="1500" data-aos-easing="ease">
                        <div class="custom_tittle">
                            <h3>Our <strong>expertise</strong> includes::</h3>
                ...
                <div class="industryNew_section2_cols">
                    <div class="row justify-content-center">
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_aspNet_icon1.png" alt="#" /></span>
                                <h6>CUSTOM ASP.NET DEVELOPMENT</h6>
                                <p>Crafting tailor-made web applications to align with your unique business requirements.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_aspNet_icon2.png" alt="#" /></span>
                                <h6>ASP.NET MVC DEVELOPMENT</h6>
                                <p>Building scalable and interactive Model-View-Controller (MVC) applications for enhanced user experiences.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_aspNet_icon3.png" alt="#" /></span>
                                <h6>ASP.NET CORE DEVELOPMENT</h6>
                                <p>Harnessing the power of ASP.NET Core for high-performance, cross-platform web applications.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_aspNet_icon4.png" alt="#" /></span>
                                <h6>ASP.NET CMS DEVELOPMENT</h6>
                                <p>Integrating ASP.NET with Content Management Systems (CMS) for efficient content creation and management.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_aspNet_icon5.png" alt="#" /></span>
                                <h6>ASP.NET E-COMMERCE SOLUTIONS</h6>
                                <p>Developing robust e-commerce platforms with secure payment gateways and engaging user interfaces.</p>
                            </div>
                        </div>

                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_aspNet_icon6.png" alt="#" /></span>
                                <h6>ASP.NET MIGRATION SERVICES</h6>
                                <p>Seamlessly transitioning your legacy applications to the latest ASP.NET frameworks for improved functionality.</p>
                            </div>
                        </div>
                
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_aspNet_icon7.png" alt="#" /></span>
                                <h6>ASP.NET API DEVELOPMENT</h6>
                                <p>Creating robust APIs to facilitate seamless integration between applications and systems.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_aspNet_icon8.png" alt="#" /></span>
                                <h6>ASP.NET SUPPORT AND MAINTENANCE</h6>
                                <p>Offering ongoing support, updates, and maintenance to ensure the longevity of your ASP.NET solutions.</p>
                            </div>
                        </div>
                    ...
                    <div class="row px-3">
                        <div class="custom_tittle pt-5 pb-0">
                            ...
                            <p class="pb-0 text-justify text-white">Leverage our ASP.NET expertise to drive innovation, efficiency, and growth in your digital ventures.</p>
                        </div>
                    </div>
                </div>
            </div>
