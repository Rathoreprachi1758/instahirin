                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-6 aos-init " data-aos="fade-right" data-aos-duration="1000" data-aos-easing="ease">
                                <div class=" custom_tittle text-left">
                                    ...
                                    Databases, <strong>Back-End Logic,</strong> Apis, Architecture, And Servers.
                                        ...
                                        <p class="p_color text-justify">Bizionic Technologies provides a range of backend technologies services, including: </p>
                                        <br>
                            ...
                            <div class="col-lg-6 col-md-6 aos-init " data-aos="fade-left" data-aos-duration="1000" data-aos-easing="ease">
                                <div class="industryNew_section1_avatar">
                                    <span><img src="/bizionic/images/t_backEnd_avatar.png" alt="#" /></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="industryNew_section2_cols">
                    <div class="row justify-content-center">
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_backEnd_icon1.png" alt="#" /></span>
                                <h6>SERVER-SIDE PROGRAMMING</h6>
                                <p>Developing robust backend logic using languages like Python, PHP, Ruby, or Node.js.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_backEnd_icon2.png" alt="#" /></span>
                                <h6>DATABASE INTEGRATION</h6>
                                <p>Integrating and optimising databases such as MySQL, PostgreSQL, MongoDB, or SQL Server.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_backEnd_icon3.png" alt="#" /></span>
                                <h6>API DEVELOPMENT</h6>
                                <p>Designing and building APIs to enable seamless communication between different software components.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_backEnd_icon4.png" alt="#" /></span>
                                <h6>SECURITY IMPLEMENTATION</h6>
                                <p>Ensuring data security through encryption, authentication, and authorisation mechanisms.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_backEnd_icon5.png" alt="#" /></span>
                                <h6>SCALABILITY SOLUTIONS</h6>
                                <p>Design backend architectures that handle increased traffic and user demand.</p>
                            </div>
                        </div>

                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_backEnd_icon6.png" alt="#" /></span>
                                <h6>CONTENT MANAGEMENT SYSTEMS (CMS)</h6>
                                <p>Implementing and customising CMS solutions like WordPress or Drupal.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_backEnd_icon7.png" alt="#" /></span>
                                <h6>SERVER CONFIGURATION AND DEPLOYMENT</h6>
                                <p>Setting up servers, configuring environments, and deploying applications.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_backEnd_icon8.png" alt="#" /></span>
                                <h6>PERFORMANCE OPTIMIZATION</h6>
                                <p>Enhancing backend performance through caching, load balancing, and efficient coding.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_backEnd_icon9.png" alt="#" /></span>
                                <h6>VERSION CONTROL</h6>
                                <p>Implementing version control systems like Git to manage code changes and collaboration.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_backEnd_icon10.png" alt="#" /></span>
                                <h6>BACKEND TESTING</h6>
                                <p>Conduct thorough testing to ensure the reliability and functionality of backend systems.</p>
                            </div>
                        </div>
                    ...
                    <div class="row px-3">
                        <div class="custom_tittle pt-5 pb-0">
                            ...
                            <p class="pb-0 text-justify text-white">With Bizionic's backend technologies expertise, businesses can build robust and scalable systems that support their applications' functionality, security, and performance requirements.</p>
                        </div>
                    </div>
                </div>
            </div>
