...
<div class="product_inner_pages bg_ebebeb">
    <div class="auto_container">
        <div class="product_inner_pagesInfo">
            ...
            <div class="product_banner maineRest_banner_bg">
                <div class="product_banner_info">
                    <div class="e_product">
                        <div class="row align-items-center">
                            <div class="col-lg-7 col-md-8">
                                <div class="custom_tittle text-left">
                                    <!-- <a href="#" class="e_logo"><img src="/bizionic/images/dubaiLand_logo.png" alt="#" /></a> -->
                                    <p class="text-white pt-3">Winning the SERP Game for</p>
                                    <h1 class="text-white">The Maine Oyster <br> Bar & Grill Dubai</h1>
                                </div>
                            </div> 
                        </div>
                    </div>
            ...
            <div class="tyre_middleEast_section" style="background:#6f7646;">
                <div class="tyre_middleEast_detail">
                    <div class="row align-items-end">  
                        <div class="col-lg-12">
                            <div class="custom_tittle p-0 text-left">
                                <p class="text-white text-justify pb-2">Joey Ghazal, the CEO of <b>The Maine Oyster Bar & Grill,</b> is known throughout the world for transforming empty spaces into conversation starters. The serial entrepreneur was recognised by Caterer Magazine as the 'Middle East Restauranteur of the Year 2018' and the '4th Most Powerful Independent Restauranteur in the Middle East' in their annual 'Power 50' issue. As such, team Bizionic Technologieshad to focus heavily on objectives and outcomes in order to maintain the company's reputation.</p>
                                <p class="text-white text-justify pb-0"><b>Bizionic Technologies</b> devised a clever plan that included building high-quality backlinks, referrals, best indexing practises, page speed optimisation, mobile responsiveness, content syndication, keyword optimisation, Click Through Rate improvement, website structure enhancement, and sitelink generation to boost the Maine's digital marketing efforts. The goal of the strategy was to increase the organic brand visibility through SEO.</p>
                            </div>
                        </div> 
                    </div>
                </div>
            ...
            <div class="stretgy_listing_section">
                <div class="stretgy_listing_sectionDetail">
                    <div class="custom_tittle">
                        <h2 class="p-0 text-left text-white"><strong>With the Right Blend of</strong> SEO Strategy, <strong>Our Efforts Resulted</strong></h2>
                    </div>
                    ...
                    <div class="stretgy_listing">
                        <ul>
                            <li>
                                <div class="stretgy_listing_info">
                                    <div class="stretgy_listing_colFr">
                                        <h5>Session Increased</h5>
                                        <strong>1017.6%</strong>
                                    </div>

                                    <div class="stretgy_listing_colFl text-left">
                                         <h4>Brand Awareness</h4>
                                         <p>Bizionic Technologies developed WOM & brand buzz using the proper combination of digital practises after examining the client's primary objective and establishing them as a premium seafood restaurant in Dubai. Our efforts in establishing and cultivating a dedicated organic community of seafood connoisseurs interested in excellent dining enabled us to assist in targeting more relevant users.</p>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="stretgy_listing_info">
                                    <div class="stretgy_listing_colFr">
                                        <h5>Visitors Increased</h5>
                                        <strong>964.3%</strong>
                                    </div>

                                    <div class="stretgy_listing_colFl  text-left">
                                         <h4>Traffic Growth</h4>
                                         <p>Bizionic Technologies used geolocation and intent data to make the website appear on prominent searches linked to the hospitality business after delving deep into the term universe and focusing precisely on the interests, demographics, and psychographics of the target population. We enhanced their traffic by optimising pages using the clever use of keywords.</p>
                                    </div>
                                </div>
                            </li> 
                            ...
                            <li>
                                <div class="stretgy_listing_info">
                                    <div class="stretgy_listing_colFr">
                                        <h5>Engagement Increased</h5>
                                        <strong>10X</strong>
                                    </div>

                                    <div class="stretgy_listing_colFl  text-left">
                                         <h4>More Interaction</h4>
                                         <p>Our digital agency increased website engagement through changing the onsite and offshore communication approach. Significant increases in bounce rates and bookings were seen at The Maine Oyster Bar & Grill as a result of improved internal linking and navigation, which also increased email and offer signups and customer interest on top pages.</p>
                                    </div>
                                </div>
                            </li> 
                        </ul>
                    ...
                    <div class="jnk_main_avatar ">
                        <span><img src="/bizionic/images/mainrest_avatar.png" alt="#" /></span>
                    </div>
