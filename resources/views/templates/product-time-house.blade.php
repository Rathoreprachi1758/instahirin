...
<div class="product_inner_pages bg_ebebeb">
    <div class="auto_container">
        <div class="product_inner_pagesInfo">
            ...
            <div class="product_banner timHouse_bannerBg">
                <div class="product_banner_info">
                    <div class="">
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-6">
                                <div class="custom_tittle p-0 text-left">
                                    <a href="#" class="e_logo"><img src="/bizionic/images/timeHouse_logo.png" alt="#" /></a>
                                    <h1 class="text-white">The Challenge</h1>

                                        <p class="text-justify p-0 text-white">With 60 locations throughout the GCC and an e-commerce website, Time House is one of the biggest online watch retailers in the UAE. Their goals were to boost sales and raise brand awareness globally.</p>
                                </div>
                            </div>

                            <div class="col-lg-6 col-md-6">
                                <div class="continental_avatar ">
                                    <span><img src="/bizionic/images/timeHouse_banner_avatar.png" alt="#" /></span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- alchmeySolution section  -->

            <div class="alchmeySolution_section timeSolution_bg">
                <div class="alchmeySolution_detail">
                    <div class="row">
                        <div class="col-lg-6 col-md-10 m-auto">
                            <div class="custom_tittle pb-5 text-left">
                                <h2 class="tittleColor3">Our Solution</h2>
                                <p class=" text-white text-justify pb-5"><b>Bizionic Technologies</b> devised and implemented a comprehensive marketing plan that included product and lifestyle photography, theme development, social media marketing, SEO, website optimisation, and performance marketing. The goal was effectively accomplished by meeting the store's key performance indicators.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- audiance_excecution section  -->
            <div class="audiance_excecution_section bg_fff">
                <div class="audiance_excecution_detail">
                    <div class="audiance_excecution_info">
                        <div class="row">
                            <div class="col-lg-4 col-md-4">
                                <div class="audiance_excecution_col">
                                    <h5>Audience</h5>
                                    ...
                                    <p>Frequent, Online Shoppers</p>

                                    <strong>Interests:</strong>
                                    <p class="p-0">Watches, Fashion, Online Shopping</p>
                                </div>
                            </div>

                            <div class="col-lg-4 col-md-4">
                                <div class="audiance_excecution_col bg_f2f2f2">
                                    <h5>Platforms</h5> 
                                    <a href="#" class="e_logo"><img src="/bizionic/images/platform_google.png" alt="#" /></a>
                                    <a href="#" class="e_logo"><img src="/bizionic/images/platform_inst.png" alt="#" /></a>
                                    <a href="#" class="e_logo"><img src="/bizionic/images/platform_ifb.png" alt="#" /></a>
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="audiance_excecution_col">
                                    ...
                                    <p>Creative Production, SEO,
                                    Website Management, Social Listening, SEM Social Media Management,
                                    Social Ads Reputation Management, Online Orders Management</p>
                                </div>
                            </div>
                        </div>
                    </div>
