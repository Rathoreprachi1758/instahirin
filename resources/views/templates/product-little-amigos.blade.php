...
<div class="product_inner_pages bg_ebebeb">
    <div class="auto_container">
        <div class="product_inner_pagesInfo">
            ...
            <div class="product_banner littileAmigos_bannnerBg">
                <div class="product_banner_info">
                    <div class="">
                        <div class="row align-items-end">
                            <div class="col-lg-6 col-md-6">
                                <div class="custom_tittle p-0 pr-3 text-left"> 
                                    <a href="#" class="e_logo"><img src="/bizionic/images/littleAmigos_logo.png" alt="#" /></a>
                                    <h1 class="text-white">UI/UX <strong>With Big Initiatives To <br>
                                        Increase Inbound Sales For The</strong> <br>
                                        Early Learning Center</h1>
                                    <p class="text-white text-justify p-0">Having a responsive school website was a key goal for <strong>Little
                                        Amigos Early Learning Centre</strong> because of a rise in parents accessing websites on the go. <strong>Little Amigos</strong> wanted 
                                        to raise brand awareness by giving their website a more modern design and feel. They wanted the website to reflect 
                                        their pleasant and caring centre, which offer excellent opportunities to children.</p>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="primeVideo_banner_avatar">
                                    <span><img src="/bizionic/images/little_amigosBanner_avatar.png" alt="#" /></span>
                                </div>
                            </div>
                        </div> 
                    </div>
            ...
            <div class="digitalExp_section  bg_fff">
                <div class="digitalExp_section_detail">
                    <div class="custom_tittle p-0">
                        <h2 style="color:#fa3d85" class="p-0">A Digital Experience For <br>
                        Little Amigos' Activities</h2>
                    </div>
                    <span><img src="/bizionic/images/digital_avatar.png" alt="#" /></span>
                </div>
            ...
            <div class="stretgy_listing_section">
                <div class="stretgy_listing_sectionDetail">
                    <div class="custom_tittle">
                        <h2 class="p-0 text-left text-white"><strong>Creating A</strong> Digital Experience <strong>To Explore</strong> Little Amigos' Activities</h2>
                    </div>
                            ...
                            <li>
                                <div class="stretgy_listing_info">
                                    <div class="stretgy_listing_colFr">
                                        <h5>Improved Brand Recognition</h5>
                                        <strong>63%</strong>
                                    </div>

                                    <div class="stretgy_listing_colFl text-left">
                                         <h4>Brand Awareness</h4>
                                         <p>Bizionic Technologies created a new responsive school website with huge, bold images to help students and parents easily find information that is relevant to them. The logo and brand colours were used throughout the site to reinforce brand recognition and develop designs that could be used as various marketing pieces.</p>
                                    </div>
                                </div>
                            </li> 
                        </ul>
                    ...
                    <div class="director_eshare beatySaloon_bg" style="background:#fa3d85">
                        <div class="custom_tittle text-left p-0">
                            <p class="text-white text-justify">We love the new look of our website. The Bizionic Technologies team did notice our needs and reached a common understanding, presented cool ideas, and discovered ways to make them work practically. They are always prompt and efficient.</p>
                            <h6 class="p-0 text-white">Mr Subrimanian, CEO of Little Amigos Early Learning Center</h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="jnk_main_avatar ">
                <span><img src="/bizionic/images/littleAmigos_featureBanner.png" alt="#" /></span>
            </div>
