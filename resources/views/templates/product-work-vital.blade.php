...
<div class="product_inner_pages bg_ebebeb">
    <div class="auto_container">
        <div class="product_inner_pagesInfo">
            ...
            <div class="product_banner workVitalBanner">
                <div class="product_banner_info">
                    <div class="">
                        <div class="row align-item-center">
                            <div class="col-lg-8 col-md-7">
                                <div class="custom_tittle p-0 pr-3 text-left"> 
                                    <a href="#" class="e_logo"><img src="/bizionic/images/workVital_logo.png" alt="#" /></a>
                                    <h1 class="text-white">Employee Management Technology <br><strong>Now Incorporate</strong></h1>
                                    <p class="text-white text-justify p-0">Maintaining staff engagement requires an art and science. As <b>WorkVitals</b> is a cloud-based programme, it is available everywhere, at all times. In order to simplify the staff management lifecycle for organisations in an understandable manner, this workforce management platform incorporates tools like shift scheduling, time and attendance, payroll, cost control, HR, forecasting & people analytics, and more. With WorkVitals, you have complete visibility and more control over your employees. We offer a plan that is specially tailored for you, regardless of the size of your company. Countless major corporations worldwide have faith in us.</p>
                            ...
                            <div class="col-lg-4 col-md-5">
                                <div class="primeVideo_banner_avatar">
                                    <span><img src="/bizionic/images/workVital_banner_avatar.png" alt="#" /></span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="stretgy_listing_section">
                <div class="stretgy_listing_sectionDetail">
                    <div class="custom_tittle">
                        <h2 class="p-0 text-left text-white"><strong>Employees' Managed Under One Umbrella Of</strong> WorkVital's Solution</h2>
                    </div>
                    ...
                    <div class="stretgy_listing">
                        <ul>
                            <li>
                                <div class="stretgy_listing_info">
                                    ...
                                    <div class="stretgy_listing_colFl text-left">
                                         <h4>Schedule Smart</h4>
                                         <p>Shifts can be structured in a fully automatic manner that detects conflicts and allows employees to swap shifts. Personal data of employees, as well as time off, are all controlled under one umbrella of employee management.</p>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="stretgy_listing_info">
                                    <div class="stretgy_listing_colFr">
                                        <h5>Productivity Up</h5>
                                        <strong>40X</strong>
                                    </div>

                                    <div class="stretgy_listing_colFl  text-left">
                                         <h4>Forecast Utilization</h4>
                                         <p>Employees' daily and demographic data is used for forecasting and decision making. A collection of reports based on real-time data gathering assist managers in decision making and forecasting.</p>
                                    </div>
                                </div>
                            </li>
                        </ul>
            ...
            <div class="p_product_slider_section">
                <div class="p_product_slider_info">
                    <div class="custom_tittle p-0 text-left">
                        <h2 class="p-0 text-left text-white"><strong>Notifications Of All</strong> Activities 
                            <strong>Across</strong> Application Send <strong>To</strong> Employees</h2>
                        <p class=" text-white"><sup>24/7 access; location-based</sup></p>
                    </div>


                    <div class="p_product_slider"> 
                        <div class="p_products">
                            <div><span><img src="/bizionic/images/applicaationSlider_avatar.png" alt=""></span></div> 
                            <div><span><img src="/bizionic/images/applicaationSlider_avatar.png" alt=""></span></div> 
                            <div><span><img src="/bizionic/images/applicaationSlider_avatar.png" alt=""></span></div> 
                            <div><span><img src="/bizionic/images/applicaationSlider_avatar.png" alt=""></span></div> 
                        </div> 
