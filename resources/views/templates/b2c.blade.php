                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="additional_benefits_text">
                                    <ul>
                                        <li><p>Back-up zones, focusing on recently viewed items.</p></li>
                                        <li><p>On Page optimization with URL sorting and proper structure.</p></li>
                                        <li><p>Effective SEO features with H1 tags and customizable URLs.</p></li>
                                        <li><p>Manage Reviews by users with publish controls.</p></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="additional_benefits_text">
                                    <ul>
                                        <li><p>Customer Account with all the order history and order status.</p></li>
                                        <li><p>Features for code activation and various offers.</p></li>
                                        <li><p>Product Management with infinite categories.</p></li>
                                        <li><p>Enables product Search across several fields and categories.</p></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
