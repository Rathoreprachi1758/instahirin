                ...
                <div class="industryNew_section_detail">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-6 aos-init " data-aos="fade-right" data-aos-duration="1000" data-aos-easing="ease">
                                <div class=" custom_tittle text-left">
                                    ...
                                    <h2 class="">
                                        ...
                                        <p class="p_color text-justify">Bizionic Technologies offers comprehensive DNN (DotNetNuke) development services to help businesses create robust and dynamic web applications.</p>
                                        <br>
                            ...
                            <div class="col-lg-6 col-md-6 aos-init " data-aos="fade-left" data-aos-duration="1000" data-aos-easing="ease">
                                <div class="industryNew_section1_avatar">
                                    <span><img src="/bizionic/images/t_dNN_avatar.png" alt="#" /></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="industryNew_section2_info aos-init" data-aos="fade-up" data-aos-duration="1500" data-aos-easing="ease">
                        <div class="custom_tittle">
                            <h3>Our <strong>DNN</strong> services include:</h3>
                ...
                <div class="industryNew_section2_cols">
                    <div class="row justify-content-center">
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_dNN_icon1.png" alt="#" /></span>
                                <h6>DNN WEBSITE DEVELOPMENT</h6>
                                <p>Crafting feature-rich and responsive websites using the DNN platform.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_dNN_icon2.png" alt="#" /></span>
                                <h6>CUSTOM MODULE DEVELOPMENT</h6>
                                <p>Designing and developing custom modules to enhance the functionality of your DNN website.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_dNN_icon3.png" alt="#" /></span>
                                <h6>SKIN DESIGN AND DEVELOPMENT</h6>
                                <p>Creating visually appealing and user-friendly skins to give your DNN website a unique look.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_dNN_icon4.png" alt="#" /></span>
                                <h6>DNN INTEGRATION SERVICES</h6>
                                <p>Integrating third-party applications, APIs, and services seamlessly with your DNN platform.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_dNN_icon5.png" alt="#" /></span>
                                <h6>DNN UPGRADE AND MIGRATION</h6>
                                <p>Upgrading your existing DNN version or migrating from other platforms to DNN for enhanced features and security.</p>
                            </div>
                        </div>

                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_dNN_icon6.png" alt="#" /></span>
                                <h6>DNN MAINTENANCE AND SUPPORT</h6>
                                <p>Providing ongoing maintenance, security updates, and technical support for your DNN website.</p>
                            </div>
                        </div>
                
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_dNN_icon7.png" alt="#" /></span>
                                <h6>PERFORMANCE OPTIMIZATION</h6>
                                <p>Enhancing the performance and speed of your DNN website for a better user experience.</p>
                            </div>
                        </div> 
                    ...
                    <div class="row px-3">
                        <div class="custom_tittle text-left pt-5 pb-0">
                            ...
                            <p class="pb-0 text-left text-white">Our skilled DNN developers leverage the capabilities of the platform to deliver customized and scalable solutions that cater to your specific business needs.</p>
                        </div>
                    </div>
                </div>
            </div>
