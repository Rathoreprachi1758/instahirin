                ...
                <div class="industryNew_section_detail">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-6 aos-init " data-aos="fade-right" data-aos-duration="1000" data-aos-easing="ease">
                                <div class="industryNew_section1_info">
                                    <h3>
                                        EXCELLENT <small>START-UP</small>  <br>
                                        SOLUTIONS FROM THE <br>
                                        <strong>EXPERTS!</strong> 
                                    </h3>

                                        <p>The Start-Up involves many essential parts for anyone seeking to launch an online business. Depending on your business model and goals, BIZIONIC
                    ...
                    <div class="industryNew_section2_info aos-init " data-aos="fade-up" data-aos-duration="1500" data-aos-easing="ease">
                        <div class="custom_tittle">
                            <h2>Start-Up Solutions, BIZIONIC Provides</h2>
                        </div>
