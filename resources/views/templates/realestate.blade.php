    ...
    <!-- main banner  -->
<head>
    <link rel="canonical" href="https://www.bizionictech.com/industries/industries-we-serve/industries/real-estate">
</head>
    ...
    <!-- industry new section section -->
        ...
        <div class="industryNew_section  bg_f2f2f2">
            <div class="auto_container">
                <div class="pageSection_icon estateReal_icon"><img src="/bizionic/images/estateReal_icon.png" alt="#" /></div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6 col-md-6 aos-init " data-aos="fade-left" data-aos-duration="1000" data-aos-easing="ease">
                                <div class="industryNew_section1_avatar">
                                    <span><img src="/bizionic/images/realEstate_avatar.png" alt="#" /></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="additional_benefits_text">
                                    <ul>
                                        <li><p>Back-up zones, focusing on recently viewed.</p></li>
                                        <li><p>Property management, Agents, accounting and all other facilities.</p></li>
                                        <li><p>Helpful for monitoring business performance.</p></li>
                                        <li><p>Users can search properties according to their criteria with
                                            interactive Google map facility.</p></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="additional_benefits_text">
                                    <ul>
                                        <li><p>Robust searching technique to enhance user experience.</p></li>
                                        <li><p>Excellent user interface to engage visitors on website.</p></li>
                                        <li><p>Responsive UI to fit each element in almost all resolutions.</p></li>
                                        <li><p>IDX listings on your real estate Agent website are
                                            Search Engine Friendly.</p></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
