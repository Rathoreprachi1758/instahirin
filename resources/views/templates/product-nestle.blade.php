...
<div class="product_inner_pages bg_ebebeb">
    <div class="auto_container">
        <div class="product_inner_pagesInfo">
            ...
            <div class="product_banner nestleBanner pb-0">
                <div class="product_banner_info">
                    <div class="nestle_product">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="custom_tittle p-0 text-left"> 
                                    <h1 class="">Nestle’s <strong>new commercial is</strong></h1>
                                    <span>#khass</span>
            ...
            <div class="director_eshare">
                <div class="custom_tittle text-left p-0">
                    <p class="text-white text-justify p-0"> The Nestle commercial creative team reached out to a number of agencies that might be able to take on the project. At last, they decided on <b>Bizionic Technologies</b> commercial ad production division (previously known as BCM). In addition to successfully assembling a team on location and meeting the deadline for directing the TV commercial at a reasonable cost, our commercial production team also met the needs of the Nestle team and their creative agency by providing the necessary production values to accurately recreate the setting and make it appear as though the commercial was shot in Pakistan or India.</p>
                </div>
            </div>
            ...
            <div class="stretgy_listing_section">
                <div class="stretgy_listing_sectionDetail">
                    <div class="custom_tittle">
                        <h2 class="p-0 text-left text-white">NESTLE MILKPAK <strong>Is What Naturally Comes To Mind!</strong></h2>
                    </div>
                            ...
                            <li>
                                <div class="stretgy_listing_info">
                                    ...
                                    <div class="stretgy_listing_colFl text-left">
                                         ...
                                         <p>Nestle is a global company best known for its high-quality food brands. They wanted to make a special advertisement for their tea and coffee whitener product specifically for India and Pakistan, two of their biggest global markets. The Nestle commercial creative team reached out to a number of agencies that might be able to take on the project.</p>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="stretgy_listing_info">
                                    ...
                                    <div class="stretgy_listing_colFl  text-left">
                                         ...
                                         <p>Bizionic Technologies production unit, not only met the deadline of putting together the team, directing and shooting the commercial for TV but also did so exactly to the standards required by the Nestle brand team and their creative agency for remarkable brand growth.</p>
                                    </div>
                                </div>
                            </li>
                        </ul>
            ...
            <!-- p_product_slider section  -->

            <div class="p_product_slider_section">
                <div class="p_product_slider_info">
                    <div class="custom_tittle">
                        <h2 class="p-0 text-left text-white">Strengthening <strong>The</strong> Bond <strong>Between</strong> Nestle <strong>And Its</strong> Fans.</h2>
                    </div>


                    <div class="p_product_slider"> 
                        <div class="p_products">
                            <div><span><img src="/bizionic/images/nestle_product1.png" alt=""></span></div> 
                            <div><span><img src="/bizionic/images/nestle_product1.png" alt=""></span></div> 
                            <div><span><img src="/bizionic/images/nestle_product1.png" alt=""></span></div> 
                            <div><span><img src="/bizionic/images/nestle_product1.png" alt=""></span></div> 
                        </div> 
