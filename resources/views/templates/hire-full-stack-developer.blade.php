                ...
                <div class="industryNew_section_detail">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-6 aos-init " data-aos="fade-right" data-aos-duration="1000" data-aos-easing="ease">
                                <div class=" custom_tittle text-left">
                                    ...
                                    <h2 class="">
                                        <strong>DESIGN AND CREATE</strong> FULL-STACK END-TO-END <strong>(FRONT-END AND BACK END)</strong> WEBSITES <strong>AND</strong> APPLICATIONS FOR VARIOUS PLATFORMS.
                                    </h2>
                            ...
                            <div class="col-lg-6 col-md-6 aos-init " data-aos="fade-left" data-aos-duration="1000" data-aos-easing="ease">
                                <div class="industryNew_section1_avatar">
                                    <span><img src="/bizionic/images/fullstack_avatar.png" alt="#" /></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="industryNew_section2_info aos-init " data-aos="fade-up" data-aos-duration="1500" data-aos-easing="ease">
                        <div class="custom_tittle">
                            <h3><strong>Here are some key areas where   </strong> Full-Stack  <strong>developers are used:</strong></h2>
                ...
                <div class="industryNew_section2_cols">
                    ...
                    <div class="row px-4">
                        <div class="custom_tittle pt-5 pb-0">
                            <p class="text-justify text-white">Overall, full-stack developers have a comprehensive skill set to handle front-end and back-end development tasks. In addition, their ability to work across different web application layers makes them versatile and valuable for projects requiring end-to-end development expertise.</p>
                            <p class="pb-0 text-justify text-white">Let Bizionic Technologies assist you in better understanding your project need and hire experienced, qualified, and prescreened Front-End Developers.  <b>Kindly provide us with your brief requirement.</b></p>
                        </div>
                    </div>
                </div>
            </div>
