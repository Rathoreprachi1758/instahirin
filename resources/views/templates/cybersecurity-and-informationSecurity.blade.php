                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-6 aos-init " data-aos="fade-right" data-aos-duration="1000" data-aos-easing="ease">
                                <div class=" custom_tittle text-left">
                                    ...
                                    Data Across <strong>All</strong> Mediums And Store It In <strong>Cyberspace.</strong>
                                        ...
                                        <p class="p_color text-justify">Bizionic Technologies offers comprehensive Cybersecurity and Information Security services, including: </p>
                                        <br>
                            ...
                            <div class="col-lg-6 col-md-6 aos-init " data-aos="fade-left" data-aos-duration="1000" data-aos-easing="ease">
                                <div class="industryNew_section1_avatar">
                                    <span><img src="/bizionic/images/t_cyberInfo_avatar.png" alt="#" /></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="industryNew_section2_cols">
                    <div class="row justify-content-center">
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_cyberInfo_icon1.png" alt="#" /></span>
                                <h6>CYBERSECURITY ASSESSMENT</h6>
                                <p>Evaluating existing security measures to identify vulnerabilities and potential risks.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_cyberInfo_icon2.png" alt="#" /></span>
                                <h6>SECURITY STRATEGY AND CONSULTATION</h6>
                                <p>Develop tailored cybersecurity strategies aligned with business goals and compliance requirements.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_cyberInfo_icon3.png" alt="#" /></span>
                                <h6>NETWORK SECURITY</h6>
                                <p>Implementing measures to protect network infrastructure from unauthorised access and attacks.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_cyberInfo_icon4.png" alt="#" /></span>
                                <h6>ENDPOINT SECURITY</h6>
                                <p>Securing individual devices and endpoints against malware, ransomware, and other threats.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_cyberInfo_icon5.png" alt="#" /></span>
                                <h6>DATA PROTECTION</h6>
                                <p>Ensuring data confidentiality and integrity through encryption and access control mechanisms.</p>
                            </div>
                        </div>

                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_cyberInfo_icon6.png" alt="#" /></span>
                                <h6>IDENTITY AND ACCESS MANAGEMENT (IAM)</h6>
                                <p>Managing user identities and controlling access to systems and data.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_cyberInfo_icon7.png" alt="#" /></span>
                                <h6>SECURITY AUDITS AND PENETRATION TESTING</h6>
                                <p>Conduct thorough audits and simulated attacks to uncover weaknesses and vulnerabilities.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_cyberInfo_icon8.png" alt="#" /></span>
                                <h6>INCIDENT RESPONSE</h6>
                                <p>Develop plans and protocols to respond effectively to security breaches and cyber incidents.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_cyberInfo_icon9.png" alt="#" /></span>
                                <h6>SECURITY TRAINING AND AWARENESS</h6>
                                <p>Educating employees on cybersecurity best practices and raising awareness about potential threats.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 provide_col">
                            <div class="industryNew_section2_colsInfo">
                                <span><img src="/bizionic/images/t_cyberInfo_icon10.png" alt="#" /></span>
                                <h6>CLOUD SECURITY</h6>
                                <p>Implementing security measures for cloud-based infrastructure and applications to protect data and resources.</p>
                            </div>
                        </div>
                    ...
                    <div class="row px-3">
                        <div class="custom_tittle pt-5 pb-0">
                            ...
                            <p class="pb-0 text-justify text-white">Bizionic's Cybersecurity and Information Security services are designed to safeguard businesses against evolving cyber threats, ensuring data privacy, compliance, and business continuity in today's digitally connected landscape.</p>
                        </div>
                    </div>
                </div>
            </div>
