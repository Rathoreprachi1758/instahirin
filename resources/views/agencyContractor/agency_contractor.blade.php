...
<style>
    ...
    .checked-label {
        ...
        background-color: #6c757d; /* Change the background color to btn-secondary */
        padding: 5px 10px; /* Adjust padding as needed */
        border-radius: 5px; /* Add border radius for rounded corners */
    }

    .select.sub-service input[type="checkbox"] {
        display: none; /* Hide the checkboxes initially */
    }
                                    ...
                                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="pills-specializations-tab"
                                                    data-bs-toggle="pill"
                                                    data-bs-target="#pills-specializations" type="button" role="tab"
                                    ...
                                    <div class="tab-pane fade" id="pills-specializations" role="tabpanel"
                                        ...
                                        <form id="myForm" action="{{route('specializationSubmit')}}" method="post">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-6">
                                                            ...
                                                            <p>Search the relevant industries for your company's
                                                                services</p>
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <p>Allocate the percentage to the applicable industries
                                                                for
                                                                your services. All industry percentages must add up
                                                                to
                                                                100%.</p>
                                                ...
                                                <button type="submit" id="submitSpecialization">Save Changes
                                                </button>
                                            </div>
                                        </form>
                                        <div class="card mt-3">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p class="card-text">Allocate a percentage to the applicable client
                                                    sizes for your services.All industry percentage percentage must
                                                    add upto 100%</p>
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="container">
                                                    ...
                                                    <div class="col-6">
                                                        <form method="post" action="{{route('clientUpdate')}}">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="range" name="mediumBusiness"
                                                                       class="form-range"
                                                            ...
                                                            <div class="form-group">
                                                                <label for="customRange3" class="form-label">Enterprise
                                                                    (> $18B)</label>
                                                                <input type="range" name="enterprise"
                                                                       class="form-range"
