                                            ...
                                            <div class="row col-12">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <p>Give Buyer A sense of how you spend your time.You must add at
                                                            least one(1) service like to your company profile</p>
                                                                                ...
                                                                                <div class="btn-group col-xs-12">
                                                                                    @foreach($agencySubServices as $agencySubService)
                                                                                        @if($agencySubService->service_id == $agencyService->id)
                                                                                            <div class="select">
                                                                                                <input type="checkbox" name="service[]" value="{{ $agencySubService->id }}" id="item_{{ $agencySubService->id }}">
