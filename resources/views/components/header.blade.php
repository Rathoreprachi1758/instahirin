            ...
            <div class="headerDetail">
                <div class="logo" style="margin-top: -15px; margin-left: -65px !important;">
                    ...
                    {{-- <a href="{{ url('/about-us') }}"> --}}
                        ...
                        <svg version="1.1" id="Layer_1" height="100px" width="150px" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    ...
                    <div class="authBttns">
                        <div class="dropdown">
                            <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="background-color:#343A40">
                                User profile
                            </button>
