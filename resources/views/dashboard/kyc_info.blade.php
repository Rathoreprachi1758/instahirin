            ...
            <div class="custom_tabs_section">
                ...
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active btn-dark" id="pills-individual-tab" data-bs-toggle="pill"
                            data-bs-target="#pills-individual" type="button" role="tab"
                            aria-controls="pills-individual" aria-selected="true">
                            I Am An Individual
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link btn-dark" id="pills-company-tab" data-bs-toggle="pill"
                            style="margin-left: 10px" data-bs-target="#pills-company" type="button" role="tab"
                            aria-controls="pills-company" aria-selected="false">
                            I Own A Company
                        </button>
                    </li>
                </ul>
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    @elseif($kyc == null)
                        <div class="alert alert-danger">
                            <span>Please complete the KYC form to access all the products and services on the Instahirin
                                platform.</span>
                        </div>
                    @endif
                                        ...
                                        <div class="kycForm_field">
                                            ...
                                            <div class="kycForm_field_info">
                                                <input name="last_name" id="last_name" autocomplete="off"
                                                    placeholder="Last Name" value="{{ $kyc?->last_name }}"
                                                    {{ $disabled }} />
                                            </div>
                                            @error('last_name')
                                                <div class="text-danger">{{ $message }}</div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12">
                                        <div class="kycForm_field">
                                            ...
                                            <select id="nationality" name="individual_nationality" class="form-select"
                                                {{ $disabled }}>
                                ...
                                <div class="row">
                                        ...
                                        <div class="kycForm_field">
                                            ...
                                            <div class="kycForm_field_info">
                                                <input type="text" placeholder="Complete Address"
                                                    name="complete_address" value="{{ $kyc?->complete_address }}"
                                                    {{ $disabled }} />
                                            </div>
                                    ...
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12">
                                        <div class="kycForm_field">
                                            ...
                                            <div class="kycForm_field_info">
                                                <input type="text" placeholder="P.O.Box" name="p_o_Box"
                                        ...
                                        <div class="kycForm_field">
                                            <div class="individual_kycForm_file">
                                                <label class="uploadFile">
                                                    <span class="individual_filename">Scanned passport / id copy
                                                        *</span>
                                                    <input type="file" class="inputfile form-control"
                                                        name="Scanned_passport" value="{{ $kyc?->Scanned_passport }}"
                                                        onchange="previewImageIndividual(this, 'imagePreview1')"
                                                        {{ $disabled }} />
                                        ...
                                        <div class="kycForm_field">
                                            ...
                                            <div class="kycForm_select">
                                                <select class="fav_show" name="individual_resident_citizen"
                                                    {{ $disabled }}>
                                                    <option value="Yes"
                                                        {{ $kyc?->resident_citizen === 'Yes' ? 'selected' : '' }}>
                                                        Yes
                                                    </option>
                                                    <option value="No"
                                                        {{ $kyc?->resident_citizen === 'No' ? 'selected' : '' }}>
                                                        No
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="kycForm_field">
                                            <div class="individual_kycForm_file">
                                                <label class="uploadFile">
                                                    ...
                                                    <input type="file" class="inputfile form-control"
                                                        name="individual_fatca" value="{{ old('FATCA') }}"
                                                        onchange="previewImageIndividual(this, 'imagePreview6')"
                                                        {{ $disabled }} />
                                                    <i class="fa fa-upload" aria-hidden="true"></i>
                                                </label>
                                            ...
                                            <div class="individual_kycForm_file">
                                                <label class="uploadFile">
                                                    ...
                                                    <input type="file" class="inputfile form-control"
                                                        ...
                                                        onchange="previewImageIndividual(this, 'imagePreview7')"
                                                        {{ $disabled }} />
                                                    <i class="fa fa-upload" aria-hidden="true"></i>
                                                </label>
                                    ...
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12">
                                        <div class="kycForm_field">
                                            <strong>Do you remit money from sanctioned
                                                countries?*</strong>
                                            <div class="kycForm_select">
                                                <select class="fav_show" name="individual_sanctionedcountries"
                                                    {{ $disabled }}>
                                                    <option value="Yes"
                                                        {{ $kyc?->sanctionedcountries === 'Yes' ? 'selected' : '' }}>
                                                        Yes
                                                    </option>
                                                    <option value="No"
                                                        {{ $kyc?->sanctionedcountries === 'No' ? 'selected' : '' }}>
                                                        No
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="kycForm_field">
                                            ...
                                            <div class="kycForm_select">
                                                <select class="fav_show"
                                                    name="individual_presencein_sanctioned_Country"
                                                    {{ $disabled }}>
                                                    <option value="Yes"
                                                        {{ $kyc?->subsidiary_office_sanctioned_Country === 'Yes' ? 'selected' : '' }}>
                                                        Yes
                                                    </option>
                                                    <option value="No"
                                                        {{ $kyc?->subsidiary_office_sanctioned_Country === 'No' ? 'selected' : '' }}>
                                                        No
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="kycForm_field">
                                            ...
                                            <div class="kycForm_select">
                                                <select class="fav_show"
                                                    ...
                                                    <option value="Yes"
                                                        {{ $kyc?->any_service_provided_in_sactioned_country === 'Yes' ? 'selected' : '' }}>
                                                        Yes
                                                    </option>
                                                    <option value="No"
                                                        {{ $kyc?->any_service_provided_in_sactioned_country === 'No' ? 'selected' : '' }}>
                                                        No
                                                    </option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="individual_kycForm_file">
                                                <label class="uploadFile">
                                                    ...
                                                    <input type="file" class="inputfile form-control"
                                                        ...
                                                        onchange="previewImageIndividual(this, 'imagePreview9')"
                                                        {{ $disabled }} />
                                                    <i class="fa fa-upload" aria-hidden="true"></i>
                                                </label>
                                            </div>
                                            ...
                                            <p>
                                                <label class="checkbox-label">
                                                    <input type="checkbox" name="individual_agrement_checkbox"
                                                        value="1"
                                                        {{ $kyc?->agrement_checkbox ? 'checked' : '' }} />
                                                    <span class="checkbox-custom rectangular"></span>
                                                </label>
                                                I agree, and confirm to the best of my knowledge that the information
                                                provided in this declaration form is current, accurate and
                                                representative of the anti-money laundering and anti-terrorist financing
                                                for the 'The Prevention of Money Laundering Act' in the relevant
                                                applicable jurisdiction and the regulations thereto: I have submitted
                                                evidence of identity and proof of address, dated within the last three
                                                months; and I hereby declare that my funds are not as a result of
                                                illegal means or activity. I also confirm and authorize letWizard
                                                platform to share my information provided in this declaration form to
                                                relevant authorities, correspondent and clearing banks and institution,
                                                and parties relevant to AML/CFT/KYC Compliance as and when requested.
                                            </p>
                                        </div>
                                        ...
                                        <div class="kycForm_field">
                                            ...
                                            <div class="kycForm_field_info">
                                                <input type="text" placeholder="Enter your Company Name"
                                                    name="Company_Name" value="{{ $kyc?->Company_Name }}"
                                                    {{ $disabled }} />
                                            </div>
                                            @error('Company_Name')
                                                <div class="text-danger">{{ $message }}</div>
                                        ...
                                        <div class="kycForm_field">
                                            ...
                                            <div class="kycForm_field_info">
                                                <input type="text" placeholder="Enter Trade Licence"
                                                    name="Licence_number" value="{{ $kyc?->Licence_number }}"
                                                    {{ $disabled }} />
                                            </div>
                                        ...
                                        <div class="kycForm_field">
                                            ...
                                            <div class="kycForm_field_info">
                                                <input name="Date_incorporation" id="datepicker3" autocomplete="off"
                                                    value="{{ Carbon::parse($kyc?->Date_incorporation)->format('d/m/Y') }} "
                                                    {{ $disabled }} />
                                            </div>
                                        ...
                                        <div class="kycForm_field">
                                            <div class="kycForm_file">
                                                <label class="uploadFile">
                                                    ...
                                                    <input type="file" class="inputfile form-control"
                                                        name="Trade_licence" value="{{ old('Trade_licence') }}"
                                        ...
                                        <div class="kycForm_field">
                                            <div class="kycForm_file">
                                                <label class="uploadFile">
                                                    ...
                                                    <input type="file" class="inputfile form-control"
                                                        name="other_doc" value="{{ old('other_doc') }}"
                                        ...
                                        <div class="kycForm_field">
                                            <div class="kycForm_file">
                                                <label class="uploadFile">
                                                    ...
                                                    <input type="file" class="inputfile form-control"
                                                        name="w_8BEN_form" value="{{ old('w_8BEN_form') }}"
                                ...
                                <div class="agreeSection">
                                    <div class="agreeSection_info">
                                        <div class="auth_text">
                                            <p>
                                                <label class="checkbox-label">
                                                    <input type="checkbox" name="agrement_checkbox" value="1"
                                                        {{ $kyc?->agrement_checkbox ? 'checked' : '' }} />
                                                    <span class="checkbox-custom rectangular"></span>
                                                </label>
                                                I agree, and confirm to the best of my knowledge that the information
...
<script>
    ...
    async function fetchIndividualNationality(selectedCountry) {
        ...
        countries.forEach(country => {
            ...
            .cca2; // Assuming 'cca2' is the country code field in the API response
    ...
    $(document).ready(function() {
        $('.nav-link').click(function() {
            $('.nav-link').removeClass('active btn-dark').addClass(
            'btn-dark'); // Reset all buttons to default state
