                    ...
                    <div class="row">
                        <div class="col-xxl-10 col-xl-11s col-lg-12 col-md-12">
                            <div class="activityTable_data">
                                <table class="table table-bordered text-center tracking-table" id="Hired">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        @forelse($Hired_applicants as $applicants)
                                            <tr>
                                                <td>
                                                    <div class="tabletext">
                                                        <p>{{ $applicants->id }}</p>
                                        ...
                                        @empty
                                            <p style="color:red">Oops ! No Records found in Hired
