           ...
           <div class="custom_tabs_section">
               ...
               <div class="custom_tabs">
                   <ul>
                       ...
                       <li><a href="{{route('master.master_leave')}}" class="active">Leave</a></li>
                                  ...
                                  <div class="col-xxl-12 ">
                                      <div class="masterTable_data">
                                          <table class="table table-striped" id="leave_master">
                                              <thead>
                                              <tr>
                                                  <th><h6 class="text-left">Leave Code</h6></th>
                                                  <th><h6 class="text-left">Leave Details</h6></th>
                                                  <th><h6 class="text-left">Encash</h6></th>
                                                  <th><h6>Annual Limit</h6></th>
                                                  <th width="140"><h6>Action</h6></th> 
                                              </tr>
                                              </thead>
                                              <tbody>
                                              <tr>
                                                  <td><div class="tabletext"><p >CL</p></div></td>
                                                  <td><div class="tabletext"><p>Casual Leave</p></div></td>
                                                  <td><div class="tabletext"><p>Yes</p></div></td>
                                                  <td><div class="tabletext"><p>14</p></div></td> 
                                                  <td>
