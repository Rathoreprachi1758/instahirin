            ...
            <div class="custom_tabs_section">
                ...
                <div class="custom_tabs">
                    <ul>
                        ...
                        <li><a href="{{ route('Designation.index') }}" class="active">Designation</a></li>
                                                ...
                                                <tbody>
                                                    @forelse( $designation as $dept)
                                                            ...
                                                            <td>
                                                                <div class="actionBtns">
                                                                    <button class="actBtn edit_company"
                                                                        ...
                                                                        data-dept-id="edit_designation_{{ $dept->id }}">
                                                                        <i class="fa fa-pencil-square-o"
                                                                            aria-hidden="true"></i>
                                                                    </button>
                                                                    <form id = "deleteForm"
                                                                        action="{{ route('Designation.destroy', $dept->id) }}"
                                                                        method="post">
                                                                        @csrf
                                                                        @method('delete')
                                                        ...
                                                        <div class="modal fade"
                                                            id="edit_designation_{{ $dept->id }}" tabindex="-1"
                                                                ...
                                                                <div class="modal-content" style="width: 173%;">
                                                                    ...
                                                                    <div class="modal-body"
                                                                        ...
                                                                        <form method="post" id="skills"
                                                                            action="{{ route('Designation.update', $dept->id) }}">
                                                                            @csrf
                                                                            @method('patch')
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <select name="dept_id"
                                                                                                    ...
                                                                                                    @foreach ($department as $id)
                                                                                                        <option
                                                                                                            value="{{ $id->id }}"
                                                                                                            @if ($id->id == $dept->department_id) selected @endif>
                                                                                                            {{ $id->department_name }}
                                                                                                        </option>
                                                                                                    @endforeach
                                                                                                </select>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 ">
                                        <div class="table_actionsBtns">
                                            <button class="tb_actionBtn" id="designation_model">Add</button>
...
{{-- //create_model --}}
<div class="modal fade" id="create_designation" tabindex="-1" role="dialog" aria-hidden="true"
    style="top: 101px;left: -186px ">
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="width: 173%;">
            <div class="modal-header" style="background-color: #BCBCBC;">
                <h6 style="padding-bottom: 0px;margin-left: 357px;">Add New Designation
                    Details</h6>
            ...
            <div class="modal-body" style="background-color: #ededed">
                <form method="post" id="skills" action="{{ route('Designation.store') }}">
                    @csrf
                    <div class="col-lg-8 col-md-10 m-auto">
                        <div class="row">
                            {{-- // --}}
...
<script>
    $(document).ready(function() {
        $('#designation_model').click(function() {
            $('#create_designation').modal('show');
        });
        //
