                    ...
                    <div class="row">
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12">
                            <div class="kycForm_field">
                                ...
                                <div class="kycForm_field_info">
                                    <input name="Date_incorporation" id="datepicker" name="date" autocomplete="false" value="{{'date'}}"/>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12">
                            <div class="kycForm_field">
                                ...
                                <div class="kycForm_field_info">
                                    <input type="text" name="beneficiary_owner" value="{{old('beneficiary_owner')}}" />
                                </div>
                            ...
                            <div class="kycForm_field">
                                <div class="kycForm_file">
                                    <label class="uploadFile">
                                        ...
                                        <input type="file" class="inputfile form-control" name="back_side_copy" value="{{old('back_side_copy')}}" />
                                        <i class="fa fa-upload" aria-hidden="true"></i>
                                    </label>
                                    <p class="p-0">
                            ...
                            <div class="kycForm_field">
                                <div class="kycForm_file">
                                    <label class="uploadFile">
                                        ...
                                        <input type="file" class="inputfile form-control" name="other_doc" value="{{old('other_doc')}}" />
                                        <i class="fa fa-upload" aria-hidden="true"></i>
                                    </label>
                                    <p>
                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12">
                            <div class="kycForm_field">
                                ...
                                <div class="kycForm_select">
                                    <select class="fav_show" name="resident_citizen" value="{{old('resident_citizen')}}">
                            ...
                            <div class="kycForm_field">
                                <div class="kycForm_file">
                                    <label class="uploadFile">
                                        ...
                                        <input type="file" class="inputfile form-control" name="FATCA" value="{{old('FATCA')}}" />
                                        <i class="fa fa-upload" aria-hidden="true"></i>
                                    </label>
                                    @error('FATCA')
                                        <div class="text-danger">{{ $message }}</div>
                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12">
                            <div class="kycForm_field">
                                <strong>Do you remit money from sanctioned
                                    countries?*</strong>
                                <div class="kycForm_select">
                                    <select class="fav_show" name="sanctionedcountries" value="{{old('sanctionedcountries')}}">
                                        <option value="Yes">Yes</option>
                                        <option value="No">No</option>
                                    </select>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12">
                            <div class="kycForm_field">
                                ...
                                <div class="kycForm_select">
                                    <select class="fav_show" name="presencein_sanctioned_Country" value="{{old('presencein_sanctioned_Country')}}">
                                        <option value="Yes">Yes</option>
                                        <option value="No">No</option>
                                    </select>
                                </div>
                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12">
                            <div class="kycForm_field">
                                <strong>Do you import/export or provide any
                                    ...
                                    Countries?*</strong>
                                <div class="kycForm_select">
                                    <select class="fav_show" name="any_service_provided_in_sactioned_country" value="{{old('any_service_provided_in_sactioned_country')}}">
                                        <option value="Yes">Yes</option>
                                        <option value="No">No</option>
                                    </select>
                                </div>
