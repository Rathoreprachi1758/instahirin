...
<body>
            ...
            <div class="main_container">
                ...
                <div class="auth_screens">
                    ...
                    {{-- <div class="authentication-button" style="display: flex; flex-direction: column">
                        <a href="{{ route('googleLogin') }}" class="btn btn-info" role="button">Login with
                            google</a><br>

                        

                        <a href="{{ route('githubLogin') }}" class="btn btn-info" role="button">Login with
                            Github</a><br>

                    </div> --}}

                    <div class="form-space" class="authentication-button" style="display: flex; flex-direction: column">
                        <button class="continue-with-btn login_with_google_btn">
                            Login with google
                            <div class="continue-with-icon">
                                <img src="bizionic/images2/google.webp" class="google_icon_image" />
                            </div>
                        </button>
                    </div>


                    <div class="form-space mt-3" class="authentication-button"
                        style="display: flex; flex-direction: column">
                        <button class="continue-with-btn2 login_with_google_btn2">
                            Login with Github
                            <div class="continue-with-icon2">
                                <img src="bizionic/images2/github.png" class="google_icon_image" />
                            </div>
                        </button>
                    </div>
                </div>
    ...
    {{-- <img src="bizionic/images2/google.webp" /> --}}
