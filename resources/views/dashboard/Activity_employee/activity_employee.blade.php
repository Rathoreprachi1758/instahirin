                                ...
                                <form id="resumeForm" action="{{ route('Employee.Resume.submit') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="updateResume">
                                        <div class="file-drop-area">
                                            ...
                                            <input type="file" class="file-input" id="fileInput" name="document" multiple>
                                            <p>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="post" id="resume_headline" action="{{route('Employee.Resume.headline')}}">
                                                            @csrf
                                        ...
                                        <div class="modal fade" id="draftModal" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="post" id="skills" action="{{route('Employee.keyskills.submit')}}">
                                                            @csrf
                                            ...
                                            <div class="modal fade" id="Add_employement" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="post" id="employment" action="{{route('Employee.Resume.employement')}}">
                                                                @csrf
                                                                ...
                                                                <input type="text" id="company_name"
                                                                    name="company_name"
                                                                    placeholder="Enter your Comapny Name" value=" "
                                            ...
                                            <div class="modal fade" id="education_model" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <br>
                                                                <form method="post" id= "graduation" action="{{route('Employee.Resume.graduation')}}">
                                                                    @csrf
                                            ...
                                            <div class="modal fade" id="secondory_education_model" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <br>
                                                                <form method="post" id="secondary" action="{{route('Employee.Resume.secondary')}}">
                                                                    @csrf
                                                                    <label for="draftMessaName">Qualification</label>
                                                                    <select class="form-control" type="text"
                                                                        id="highest_qualification" name="highest_qualification"
