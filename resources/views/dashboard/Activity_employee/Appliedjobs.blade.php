                ...
                <div class="custom_tabs_data" style="display: block" id="tab3">
                    <div class="col-xxl-9 col-xl-10 col-lg-11 col-md-12">
                        <div class="activityTable_data">
                            <table class="table table-striped" id="applied_jobs">
                                <thead>
                                    <tr>
                                        <th>
                                            <h6>Id</h6>
                                    ...
                                    @forelse($jobsWithApplicants as $job)
                                        {{-- @foreach($job->applicants as $applicant) --}}
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="tabletext">
                                                        <p>{{$job->current_title}}</p>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="tabletext">
                                                        <p>{{$job->experience_year}}.{{$job->experience_month}}</p>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="tabletext">
                                                ...
                                                <td>
                                                    <div class="tabletext">
                                                        <p>{{$job->availability_date}}</p>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="tabletext">
                                                        <p style="width:70px">{{$job->applied_on}}</p>
                                                    </div>
                                                </td>
                                            </tr>
                                            @empty
                                            <p style="color:red">Oops ! No jobs you were applied<?xml version="1.0" standalone="no"?>
