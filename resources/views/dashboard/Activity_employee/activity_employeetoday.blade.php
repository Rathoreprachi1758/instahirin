                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <form method="post"
                                                                                    ...
                                                                                    @foreach ($userdata as $user)
                                                                                        ...
                                                                                        <br />
                                                                                        <label
                                                                                            for="Availability">Availability<span
                                                                                                class="required"
                                                                                                style="color: red;margin-left: 3px;">*</span></label>
                                                                                        <select style="width: 89%"
                                                                                            class="form-control"
                                                                                        ...
                                                                                        {{-- // --}}
                                                                                        <label
                                                                                            for="Home_town">Nationality</label>
                                                                                        <select name="nationality"
                                                                                            class="form-control"
                                                                                            style ="width:89%"
                                                                                            required
