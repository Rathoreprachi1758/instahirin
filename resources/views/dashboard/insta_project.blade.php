                        ...
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                            ...
                            <form class="row g-3" action="{{route('instaProjectReviewSubmit')}}" method="post">
                                ...
                                <div class="rating" id="quality_deliverable_rating">
                                    <input type="radio" id="qd_star5" name="quality_deliverable_rating" value="5"/>
                                    <label for="qd_star5"></label>
                                    <input type="radio" id="qd_star4" name="quality_deliverable_rating" value="4"/>
                                    <label for="qd_star4"></label>
                                    <input type="radio" id="qd_star3" name="quality_deliverable_rating" value="3"/>
                                    <label for="qd_star3"></label>
                                    <input type="radio" id="qd_star2" name="quality_deliverable_rating" value="2"/>
                                    <label for="qd_star2"></label>
                                    <input type="radio" id="qd_star1" name="quality_deliverable_rating" value="1"/>
                                ...
                                <div class="rating" id="time_lines_marketing_rating">
                                    <input type="radio" id="tm_star5" name="time_lines_marketing_rating" value="5"/>
                                    <label for="tm_star5"></label>
                                    <input type="radio" id="tm_star4" name="time_lines_marketing_rating" value="4"/>
                                    <label for="tm_star4"></label>
                                    <input type="radio" id="tm_star3" name="time_lines_marketing_rating" value="3"/>
                                    <label for="tm_star3"></label>
                                    <input type="radio" id="tm_star2" name="time_lines_marketing_rating" value="2"/>
                                    <label for="tm_star2"></label>
                                    <input type="radio" id="tm_star1" name="time_lines_marketing_rating" value="1"/>
                                ...
                                <div class="col-4">
                                    <div class="card" style="width: 18rem;">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item">Quality of service and deliverable {{$instaProjectReview->quality_deliverable_rating}}</li>
                                            <li class="list-group-item">Cost and value of money {{$instaProjectReview->cost_value_rating}}</li>
                                            <li class="list-group-item">Timelines and marketing deadlines {{$instaProjectReview->time_lines_marketing_rating}}</li>
                                            <li class="list-group-item">Over all experience {{$instaProjectReview->over_all_rating}}</li>
                                        </ul>
                                    </div>
                                </div>
                                @endforeach
